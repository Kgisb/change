...
# ---- Refresh button styles (scoped) ----
try:
    import streamlit as st
    st.markdown("""
<style>
/* Scope only inside #refresh-ctl to avoid touching other buttons */
...
#refresh-ctl .stButton > button:hover { transform: translateY(-1px); box-shadow: 0 12px 28px rgba(2,132,199,0.32); }
#refresh-ctl .stButton > button:active { transform: translateY(0); box-shadow: 0 6px 16px rgba(2,132,199,0.28); }
</style>
""", unsafe_allow_html=True)
except Exception:
    pass
