...
def _inject_global_ui_css():
    ...
    st.markdown(
        ...
        div[data-testid="stMetric"] [data-testid="stMetricDelta"] svg { margin-top: 2px; }
        /* Expanders */
        ...
        /* Inputs */
        div[data-baseweb="select"], .stTextInput > div, .stNumberInput > div, .stDateInput > div {
        ...
        /* Gentle dividers between blocks */
        .stMarkdown hr {
            margin: 18px 0;
            border: none;
...
# Call early at top-level to ensure styles apply everywhere
...
def _render_data_sources_expander():
    ...
    DATA_SOURCE_TEXT = (
        ...
        "• Notes: Invalid deals (Deal Stage = '1.2 Invalid deal(s)') are excluded"
    )
    st.markdown("<div style='height:18px'></div>", unsafe_allow_html=True)  # small spacer
