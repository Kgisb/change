...
# =========================
    ...
    with st.expander('Cash-in — Google Sheet snapshot', expanded=False):
        st.caption('Google Sheet URL')
        st.markdown('[Open the Google Sheet](https://docs.google.com/spreadsheets/d/1tw6gTaUEycAD5DJjw5ASSdF-WwYEt2TqcMb2lTKtKps/edit?gid=0#gid=0)')
# =========================
# =========================
# =========================================
